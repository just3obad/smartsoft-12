NokiaRuby::Application.routes.draw do
  ...
  match "authenticate/get_twitter_url" => "twitter_requests#generate_request_token"
  ...
  match "friends/:id/update" => "friends#update"
  match "friends/:id/delete" => "friends#delete"
