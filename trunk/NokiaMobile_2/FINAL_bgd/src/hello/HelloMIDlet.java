...
//GEN-LINE:|7-commandAction|32|79-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|33|378-preAction
        } else if (displayable == Toggle) {
            if (command == backCommand13) {//GEN-END:|7-commandAction|33|378-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|34|378-postAction
                // write post-action user code here
            } else if (command == choose) {//GEN-LINE:|7-commandAction|35|380-preAction
                // write pre-action user code here
                ...
                switchDisplayable(null, getInterestConfirm());//GEN-LINE:|7-commandAction|36|380-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|37|345-preAction
        } else if (displayable == URLCorrupted) {
            if (command == okCommand11) {//GEN-END:|7-commandAction|37|345-preAction
                // write pre-action user code here
                switchDisplayable(null, getAuthTwitter());//GEN-LINE:|7-commandAction|38|345-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|39|170-preAction
        } else if (displayable == Verification) {
            if (command == Resend) {//GEN-END:|7-commandAction|39|170-preAction
                // write pre-action user code here
...
//GEN-LINE:|7-commandAction|40|170-postAction
                // write post-action user code here
            } else if (command == Verify) {//GEN-LINE:|7-commandAction|41|168-preAction
                // write pre-action user code here
                if(checkInternetConn() && checkServerConn()){
        ...
        try {
            ...
            System.out.println("Exception occured " + t.toString());
             ...
             switchDisplayable(IncorrectCode, getVerification());
                ...
                if(response1.equalsIgnoreCase("true")){
                    switchDisplayable(null, getMainFeed());//GEN-LINE:|7-commandAction|42|168-postAction
                }// write post-action user code here
                
            } else if (command == backV) {//GEN-LINE:|7-commandAction|43|166-preAction
                // write pre-action user code here
                switchDisplayable(null, getMainFeed());//GEN-LINE:|7-commandAction|44|166-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|45|283-preAction
        } else if (displayable == alreadyHaveTwitter) {
            if (command == BackToAccounts) {//GEN-END:|7-commandAction|45|283-preAction
                // write pre-action user code here
                switchDisplayable(null, getConnectAccount());//GEN-LINE:|7-commandAction|46|283-postAction
                // write post-action user code here
            } else if (command == ReplaceTwitterAccount) {//GEN-LINE:|7-commandAction|47|281-preAction
                // write pre-action user code here
                genReqURL();//GEN-LINE:|7-commandAction|48|281-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|49|296-preAction
        } else if (displayable == authSuccessful) {
            if (command == BackToAccounts) {//GEN-END:|7-commandAction|49|296-preAction
                // write pre-action user code here
                switchDisplayable(null, getConnectAccount());//GEN-LINE:|7-commandAction|50|296-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|51|253-preAction
        } else if (displayable == authTwitter) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|51|253-preAction
                // write pre-action user code here
                authTwitterAction();//GEN-LINE:|7-commandAction|52|253-postAction
                // write post-action user code here
            } else if (command == backCommand2) {//GEN-LINE:|7-commandAction|53|266-preAction
                // write pre-action user code here
                switchDisplayable(null, getConnectAccount());//GEN-LINE:|7-commandAction|54|266-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|55|123-preAction
        } else if (displayable == choosefriend1) {
            if (command == Find) {//GEN-END:|7-commandAction|55|123-preAction
                // write pre-action user code here
                switchDisplayable(null, getFindFriend());//GEN-LINE:|7-commandAction|56|123-postAction
                // write post-action user code here
            } else if (command == List.SELECT_COMMAND) {//GEN-LINE:|7-commandAction|57|117-preAction
                // write pre-action user code here
                choosefriend1Action();//GEN-LINE:|7-commandAction|58|117-postAction
                // write post-action user code here
            } else if (command == backCommand4) {//GEN-LINE:|7-commandAction|59|122-preAction
                // write pre-action user code here
                switchDisplayable(null, getRecommend());//GEN-LINE:|7-commandAction|60|122-postAction
                // write post-action user code here
            } else if (command == okCommand2) {//GEN-LINE:|7-commandAction|61|120-preAction
                // write pre-action user code here
                switchDisplayable(null, getRecommend());//GEN-LINE:|7-commandAction|62|120-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|63|81-preAction
        } else if (displayable == connectAccount) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|63|81-preAction
                // write pre-action user code here
                connectAccountAction();//GEN-LINE:|7-commandAction|64|81-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|65|312-preAction
        } else if (displayable == disliked) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|65|312-preAction
                // write pre-action user code here
                dislikedAction();//GEN-LINE:|7-commandAction|66|312-postAction
                // write post-action user code here
            } else if (command == backCommand) {//GEN-LINE:|7-commandAction|67|314-preAction
                // write pre-action user code here
                switchDisplayable(null, getReadMore());//GEN-LINE:|7-commandAction|68|314-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|69|106-preAction
        } else if (displayable == findFriend) {
            if (command == Add1) {//GEN-END:|7-commandAction|69|106-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|70|106-postAction
            ...
            } else if (command == Back1) {//GEN-LINE:|7-commandAction|71|94-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|72|94-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|73|19-preAction
        } else if (displayable == form) {
            if (command == exitCommand) {//GEN-END:|7-commandAction|73|19-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|74|19-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|75|159-preAction
        } else if (displayable == form1) {
            if (command == backCommand8) {//GEN-END:|7-commandAction|75|159-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|76|159-postAction
                // write post-action user code here
            } else if (command == okCommand6) {//GEN-LINE:|7-commandAction|77|161-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|78|161-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|79|383-preAction
        } else if (displayable == interestConfirm) {
            if (command == backCommand14) {//GEN-END:|7-commandAction|79|383-preAction
                // write pre-action user code here
                switchDisplayable(null, getToggle());//GEN-LINE:|7-commandAction|80|383-postAction
                // write post-action user code here
            } else if (command == okCommand13) {//GEN-LINE:|7-commandAction|81|385-preAction
                // write pre-action user code here
                   UserInterestsJson();
//GEN-LINE:|7-commandAction|82|385-postAction
                // write post-action user code here
            ...
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|87|182-preAction
                ...
                // write post-action user code here
            } else if (command == back) {//GEN-LINE:|7-commandAction|89|367-preAction
                // write pre-action user code here
                 switchDisplayable(null, getMainFeed());
//GEN-LINE:|7-commandAction|90|367-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|108|186-postAction
                ...
                switchDisplayable(null, getMainFeed());//GEN-LINE:|7-commandAction|110|200-postAction
                // write post-action user code here
                ...
                if (r.equals("story is blocked successfully")) {
                    switchDisplayable(null, getMainFeed());//GEN-LINE:|7-commandAction|112|202-postAction
                } else
...
//GEN-LINE:|7-commandAction|114|194-postAction
                ...
                switchDisplayable(null, getDisliked());//GEN-LINE:|7-commandAction|116|319-postAction
                // write post-action user code here
                ...
                switchDisplayable(null, getLiked());//GEN-LINE:|7-commandAction|118|317-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|120|188-postAction
                ...
                // write pre-action user code here
                shareonnetwork();//GEN-LINE:|7-commandAction|124|196-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|130|190-postAction
                // write post-action user code here
            } else if (command == viewCommentsMany) {//GEN-LINE:|7-commandAction|131|356-preAction
                // write pre-action user code here
                switchDisplayable(null, getCommentsMany());//GEN-LINE:|7-commandAction|132|356-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|138|113-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|142|33-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|143|305-preAction
        } else if (displayable == twitterAuthFailed) {
            if (command == BackToAccounts) {//GEN-END:|7-commandAction|143|305-preAction
                // write pre-action user code here
                switchDisplayable(null, getConnectAccount());//GEN-LINE:|7-commandAction|144|305-postAction
                // write post-action user code here
            } else if (command == Resend1) {//GEN-LINE:|7-commandAction|145|302-preAction
                // write pre-action user code here
                genReqURL();//GEN-LINE:|7-commandAction|146|302-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|147|7-postCommandAction
        }//GEN-END:|7-commandAction|147|7-postCommandAction
        // write post-action user code here
    }//GEN-BEGIN:|7-commandAction|148|
    //</editor-fold>//GEN-END:|7-commandAction|148|
