...
//GEN-LINE:|0-initialize|1|0-postInitialize
    ...
    public void startMIDlet() {//GEN-END:|3-startMIDlet|0|3-preAction
        ...
        switchDisplayable(null, getHeader());//GEN-LINE:|3-startMIDlet|1|3-postAction
    ...
    public TextBox getHeader() {
        if (header == null) {//GEN-END:|18-getter|0|18-preInit
            ...
            header = new TextBox("textBox", "Welcome to my first calculator !!", 100, TextField.ANY);//GEN-BEGIN:|18-getter|1|18-postInit
    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == form) {//GEN-BEGIN:|7-commandAction|1|50-preAction
            if (command == EqualCommand3) {//GEN-END:|7-commandAction|1|50-preAction
                ...
                for(int i=0;i<y.length();i++){
                    if(y.charAt(i)=='+' || y.charAt(i)=='-' ||y.charAt(i)=='*' ||y.charAt(i)=='/'){
                         ...
                         {
                        case '+':
                           n1 = Integer.parseInt(y.substring(0, y.indexOf("+")));
                           n2 = Integer.parseInt(y.substring(y.indexOf("+")+1, y.length()));
                           resulted = n1+n2;
                           a.setText(resulted + "");
                           textField.setString(resulted+"");
                           break;
                        case '-':
                           n1 = Integer.parseInt(y.substring(0, y.indexOf("-")));
                           n2 = Integer.parseInt(y.substring(y.indexOf("-")+1, y.length()));
                        ...
                        case '/':
                           ...
                           n2 = Integer.parseInt(y.substring(y.indexOf("/")+1, y.length()));
                            ...
                            break;                   
                                ...
                                resulted = 0;
                                a.setText("Don't divide by zero tany");
                                textField.setString(resulted + "");
                                break;
                            } 
                        default :a.setText(textField.getString()) ;break;
                            }
                    }else{
                        try{
                            Integer.parseInt(y.charAt(i)+"");
                        }catch(Exception e){
                        a.setText("Don't enter 7rof dh calculator");
                ...
                a.setText(null);
                form.addCommand(SelectOp);
                switchDisplayable(null, getHeader());//GEN-LINE:|7-commandAction|4|53-postAction
                // write post-action user code here
            ...
            if (command == okCommand) {//GEN-END:|7-commandAction|7|23-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm());//GEN-LINE:|7-commandAction|8|23-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|9|28-preAction
        } else if (displayable == list) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|9|28-preAction
                // write pre-action user code here
                listAction();//GEN-LINE:|7-commandAction|10|28-postAction
                // write post-action user code here
            } else if (command == backCommand) {//GEN-LINE:|7-commandAction|11|44-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm());//GEN-LINE:|7-commandAction|12|44-postAction
                // write post-action user code here
    ...
    public Form getForm() {
        if (form == null) {//GEN-END:|25-getter|0|25-preInit
            // write pre-init user code here
            form = new Form("Calculator Application", new Item[] { getTextField() });//GEN-BEGIN:|25-getter|1|25-postInit
...
//GEN-LINE:|26-action|8|33-postAction
    ...
    public Command getEqualCommand3() {
        if (EqualCommand3 == null) {//GEN-END:|49-getter|0|49-preInit
            // write pre-init user code here
            EqualCommand3 = new Command("Equal", Command.OK, 0);//GEN-LINE:|49-getter|1|49-postInit
            // write post-init user code here
    ...
    public Command getNewCommand() {
        if (NewCommand == null) {//GEN-END:|52-getter|0|52-preInit
            // write pre-init user code here
            NewCommand = new Command("New", Command.ITEM, 0);//GEN-LINE:|52-getter|1|52-postInit
            // write post-init user code here
