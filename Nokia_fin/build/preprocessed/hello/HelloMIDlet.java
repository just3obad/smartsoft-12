...
//</editor-fold>//GEN-END:|fields|0|
    private HttpConnection httpConn1;
    ...
    if(s.equals(null) || s.equals("")){
     ...
     //   getTextField().n
      ...
      //  getDisplay().setCurrent(displayable);
            ...
            if (command == Filter) {//GEN-END:|7-commandAction|5|112-preAction
                test();
                switchDisplayable(null, getList());//GEN-LINE:|7-commandAction|6|112-postAction
                // write post-action user code here
            } else if (command == options) {//GEN-LINE:|7-commandAction|7|63-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|8|63-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|12|31-postAction
                // write post-action user code here
            } else if (command == okCommand1) {//GEN-LINE:|7-commandAction|13|79-preAction
 // write pre-action user code here
//GEN-LINE:|7-commandAction|14|79-postAction
 // write post-action user code here
...
//GEN-LINE:|7-commandAction|24|19-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|25|109-preAction
        } else if (displayable == list) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|25|109-preAction
                // write pre-action user code here
                listAction();//GEN-LINE:|7-commandAction|26|109-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|27|53-preAction
        } else if (displayable == profile) {
            if (command == back) {//GEN-END:|7-commandAction|27|53-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|28|53-postAction
                // write post-action user code here
            } else if (command == ok) {//GEN-LINE:|7-commandAction|29|49-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|30|49-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|31|35-preAction
        } else if (displayable == textBox) {
            if (command == backCommand1) {//GEN-END:|7-commandAction|31|35-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|32|35-postAction
                // write post-action user code here
            } else if (command == okCommand) {//GEN-LINE:|7-commandAction|33|33-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|34|33-postAction
                // write post-action user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: Find ">//GEN-BEGIN:|95-getter|0|95-preInit
    ...
    public Command getFind() {
        if (Find == null) {//GEN-END:|95-getter|0|95-preInit
            // write pre-init user code here
            Find = new Command("Ok", Command.OK, 0);//GEN-LINE:|95-getter|1|95-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: Filter ">//GEN-BEGIN:|111-getter|0|111-preInit
    /**
    ...
    public Command getFilter() {
        if (Filter == null) {//GEN-END:|111-getter|0|111-preInit
            // write pre-init user code here
            Filter = new Command("Back", Command.BACK, 0);//GEN-LINE:|111-getter|1|111-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: list ">//GEN-BEGIN:|108-getter|0|108-preInit
    /**
     ...
     */
    public List getList() {
        if (list == null) {//GEN-END:|108-getter|0|108-preInit
            // write pre-init user code here
            list = new List("list", Choice.IMPLICIT);//GEN-BEGIN:|108-getter|1|108-postInit
            list.setCommandListener(this);//GEN-END:|108-getter|1|108-postInit
            // write post-init user code here
...
public static void parseJsonInterest(String x)
{
    String interest = "";
    for(int i=0; i<x.length(); i++)
    {
...
//<editor-fold defaultstate="collapsed" desc=" Generated Method: listAction ">//GEN-BEGIN:|108-action|0|108-preAction
    /**
     * Performs an action assigned to the selected list element in the list
     * component.
     */
    public void listAction() {//GEN-END:|108-action|0|108-preAction
        // enter pre-action user code here
        String __selectedString = getList().getString(getList().getSelectedIndex());//GEN-LINE:|108-action|1|108-postAction
        // enter post-action user code here
