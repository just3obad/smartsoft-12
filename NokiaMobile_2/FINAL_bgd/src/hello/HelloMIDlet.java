...
//GEN-LINE:|7-commandAction|14|135-postAction
            ...
            if (command == FilterFriends) {//GEN-END:|7-commandAction|15|233-preAction
                ...
                // write pre-action user code here
                switchDisplayable(null, getVerification());//GEN-LINE:|7-commandAction|20|370-postAction
                // write post-action user code here
    ...
    //it is necessary to clean them up as soon as we are done with them.
        ...
        try {
         ...
         //}                       
              ...
              //  if(response1.equalsIgnoreCase("true")){
//GEN-LINE:|7-commandAction|42|168-postAction
              //  }// write post-action user code here
...
//GEN-LINE:|7-commandAction|142|33-postAction
    ...
    /**
     * Returns an initiliazed instance of ConnectionError component.
     * @return the initialized component instance
     */
    ...
    /**
     * Returns an initiliazed instance of indicator5 component.
     * @return the initialized component instance
     */
