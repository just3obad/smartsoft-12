...
//GEN-LINE:|7-commandAction|36|170-postAction
                ...
                // write pre-action user code here
//GEN-LINE:|7-commandAction|38|168-postAction
                // write post-action user code here
            } else if (command == backV) {//GEN-LINE:|7-commandAction|39|166-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|40|166-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|41|123-preAction
        } else if (displayable == choosefriend1) {
            if (command == Find) {//GEN-END:|7-commandAction|41|123-preAction
                // write pre-action user code here
                switchDisplayable(null, getFindFriend());//GEN-LINE:|7-commandAction|42|123-postAction
                // write post-action user code here
            } else if (command == List.SELECT_COMMAND) {//GEN-LINE:|7-commandAction|43|117-preAction
                // write pre-action user code here
                choosefriend1Action();//GEN-LINE:|7-commandAction|44|117-postAction
                // write post-action user code here
            } else if (command == backCommand4) {//GEN-LINE:|7-commandAction|45|122-preAction
                // write pre-action user code here
                switchDisplayable(null, getRecommend());//GEN-LINE:|7-commandAction|46|122-postAction
                // write post-action user code here
            } else if (command == okCommand2) {//GEN-LINE:|7-commandAction|47|120-preAction
                // write pre-action user code here
                switchDisplayable(null, getRecommend());//GEN-LINE:|7-commandAction|48|120-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|49|81-preAction
        } else if (displayable == connectAccount) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|49|81-preAction
                // write pre-action user code here
                connectAccountAction();//GEN-LINE:|7-commandAction|50|81-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|51|106-preAction
        } else if (displayable == findFriend) {
            if (command == Add1) {//GEN-END:|7-commandAction|51|106-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|52|106-postAction
            ...
            } else if (command == Back1) {//GEN-LINE:|7-commandAction|53|94-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|54|94-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|55|19-preAction
        } else if (displayable == form) {
            if (command == exitCommand) {//GEN-END:|7-commandAction|55|19-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|56|19-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|57|159-preAction
        } else if (displayable == form1) {
            if (command == backCommand8) {//GEN-END:|7-commandAction|57|159-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|58|159-postAction
                // write post-action user code here
            } else if (command == okCommand6) {//GEN-LINE:|7-commandAction|59|161-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|60|161-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|61|128-preAction
        } else if (displayable == likeddisliked) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|61|128-preAction
                // write pre-action user code here
                likeddislikedAction();//GEN-LINE:|7-commandAction|62|128-postAction
                // write post-action user code here
            } else if (command == backCommand) {//GEN-LINE:|7-commandAction|63|130-preAction
                // write pre-action user code here
                switchDisplayable(null, getReadMore());//GEN-LINE:|7-commandAction|64|130-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|65|182-preAction
        } else if (displayable == list) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|65|182-preAction
                // write pre-action user code here
                listAction();//GEN-LINE:|7-commandAction|66|182-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|67|236-preAction
        } else if (displayable == list1) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|67|236-preAction
                // write pre-action user code here
                list1Action();//GEN-LINE:|7-commandAction|68|236-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|69|53-preAction
        } else if (displayable == profile) {
            if (command == back) {//GEN-END:|7-commandAction|69|53-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|70|53-postAction
                // write post-action user code here
            } else if (command == ok) {//GEN-LINE:|7-commandAction|71|49-preAction
                // write pre-action user code here
               //String dataToBeSend = "{\"created_at\":\"nil\",\"email\":\"menisy@abfcge.com\",\"name\":\"menisy\",\"updated_at\":\"nil\"}"
               String s ="";
//               int anyInfo = 0;
...
//                   }
//               }
//GEN-LINE:|7-commandAction|72|49-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|73|186-preAction
        } else if (displayable == readMore) {
            if (command == backCommand9) {//GEN-END:|7-commandAction|73|186-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|74|186-postAction
                 // write post-action user code here
            } else if (command == blockinterest) {//GEN-LINE:|7-commandAction|75|200-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|76|200-postAction
                 // write post-action user code here
            } else if (command == blockstory) {//GEN-LINE:|7-commandAction|77|202-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|78|202-postAction
                 // write post-action user code here
            } else if (command == flag) {//GEN-LINE:|7-commandAction|79|194-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|80|194-postAction
                 // write post-action user code here
            } else if (command == okCommand7) {//GEN-LINE:|7-commandAction|81|188-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|82|188-postAction
                 // write post-action user code here
            } else if (command == recommend1) {//GEN-LINE:|7-commandAction|83|198-preAction
                 // write pre-action user code here
                switchDisplayable(null, getRecommend());//GEN-LINE:|7-commandAction|84|198-postAction
                 // write post-action user code here
            } else if (command == share) {//GEN-LINE:|7-commandAction|85|196-preAction
                 // write pre-action user code here
                method();//GEN-LINE:|7-commandAction|86|196-postAction
                 // write post-action user code here
            } else if (command == signout) {//GEN-LINE:|7-commandAction|87|204-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|88|204-postAction
                 // write post-action user code here
            } else if (command == thumbdown) {//GEN-LINE:|7-commandAction|89|192-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|90|192-postAction
                 // write post-action user code here
            } else if (command == thumbup) {//GEN-LINE:|7-commandAction|91|190-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|92|190-postAction
                 // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|93|115-preAction
        } else if (displayable == recommend) {
            if (command == backCommand3) {//GEN-END:|7-commandAction|93|115-preAction
                // write pre-action user code here
                switchDisplayable(null, getReadMore());//GEN-LINE:|7-commandAction|94|115-postAction
                // write post-action user code here
            } else if (command == choosefriend) {//GEN-LINE:|7-commandAction|95|124-preAction
                // write pre-action user code here
                switchDisplayable(null, getChoosefriend1());//GEN-LINE:|7-commandAction|96|124-postAction
                // write post-action user code here
            } else if (command == okCommand) {//GEN-LINE:|7-commandAction|97|113-preAction
                // write pre-action user code here
                switchDisplayable(null, getReadMore());//GEN-LINE:|7-commandAction|98|113-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|99|35-preAction
        } else if (displayable == textBox) {
            if (command == backCommand1) {//GEN-END:|7-commandAction|99|35-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|100|35-postAction
                // write post-action user code here
            } else if (command == okCommand) {//GEN-LINE:|7-commandAction|101|33-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|102|33-postAction
                // write post-action user code here
