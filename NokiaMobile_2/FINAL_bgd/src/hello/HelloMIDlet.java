...
//GEN-LINE:|7-commandAction|10|38-postAction
                // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|11|239-preAction
         } else if (displayable == FriendList) {
             if (command == Block) {//GEN-END:|7-commandAction|11|239-preAction
                 // write pre-action user code here
                 switchDisplayable(null, getFriendsStories());//GEN-LINE:|7-commandAction|12|239-postAction
                 // write post-action user code here
             } else if (command == Filter) {//GEN-LINE:|7-commandAction|13|241-preAction
                // write pre-action user code here
                 switchDisplayable(null, getFriendsStories());//GEN-LINE:|7-commandAction|14|241-postAction
                // write post-action user code here
             } else if (command == List.SELECT_COMMAND) {//GEN-LINE:|7-commandAction|15|230-preAction
                // write pre-action user code here
                 FriendListAction();//GEN-LINE:|7-commandAction|16|230-postAction
                // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|17|137-preAction
         } else if (displayable == LoginScreen) {
             if (command == backCommand5) {//GEN-END:|7-commandAction|17|137-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|18|137-postAction
                // write post-action user code here
             } else if (command == okCommand3) {//GEN-LINE:|7-commandAction|19|135-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|20|135-postAction
                // write post-action user code here
                                                 HttpConnection httpConn = null;
                InputStream is = null;
                OutputStream os = null;
    ...
    //it is necessary to clean them up as soon as we are done with them.
        ...
        try {
            ...
            System.out.println("Exception occured " + t.toString());
             ...
             }//GEN-BEGIN:|7-commandAction|21|233-preAction
         } else if (displayable == MainFeed) {
             if (command == FilterFriends) {//GEN-END:|7-commandAction|21|233-preAction
                // write pre-action user code here
                 switchDisplayable(null, getFriendList());//GEN-LINE:|7-commandAction|22|233-postAction
                // write post-action user code here
             } else if (command == options) {//GEN-LINE:|7-commandAction|23|63-preAction
                // write pre-action user code here
...
//GEN-LINE:|7-commandAction|34|79-postAction
 // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|35|345-preAction
         } else if (displayable == URLCorrupted) {
             if (command == okCommand11) {//GEN-END:|7-commandAction|35|345-preAction
                // write pre-action user code here
                 switchDisplayable(null, getAuthTwitter());//GEN-LINE:|7-commandAction|36|345-postAction
                // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|37|170-preAction
         } else if (displayable == Verification) {
             if (command == Resend) {//GEN-END:|7-commandAction|37|170-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|38|170-postAction
                // write post-action user code here
             } else if (command == Verify) {//GEN-LINE:|7-commandAction|39|168-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|40|168-postAction
                // write post-action user code here
             } else if (command == backV) {//GEN-LINE:|7-commandAction|41|166-preAction
                // write pre-action user code here
//GEN-LINE:|7-commandAction|42|166-postAction
                // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|43|283-preAction
         } else if (displayable == alreadyHaveTwitter) {
             if (command == BackToAccounts) {//GEN-END:|7-commandAction|43|283-preAction
                 // write pre-action user code here
                 switchDisplayable(null, getConnectAccount());//GEN-LINE:|7-commandAction|44|283-postAction
                 // write post-action user code here
             } else if (command == ReplaceTwitterAccount) {//GEN-LINE:|7-commandAction|45|281-preAction
                 // write pre-action user code here
                 genReqURL();//GEN-LINE:|7-commandAction|46|281-postAction
                 // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|47|296-preAction
         } else if (displayable == authSuccessful) {
             if (command == BackToAccounts) {//GEN-END:|7-commandAction|47|296-preAction
                 // write pre-action user code here
                 switchDisplayable(null, getConnectAccount());//GEN-LINE:|7-commandAction|48|296-postAction
                 // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|49|253-preAction
         } else if (displayable == authTwitter) {
             if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|49|253-preAction
                 // write pre-action user code here
                 authTwitterAction();//GEN-LINE:|7-commandAction|50|253-postAction
                 // write post-action user code here
             } else if (command == backCommand2) {//GEN-LINE:|7-commandAction|51|266-preAction
                 // write pre-action user code here
                 switchDisplayable(null, getConnectAccount());//GEN-LINE:|7-commandAction|52|266-postAction
                 // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|53|123-preAction
         } else if (displayable == choosefriend1) {
             if (command == Find) {//GEN-END:|7-commandAction|53|123-preAction
                // write pre-action user code here
                 switchDisplayable(null, getFindFriend());//GEN-LINE:|7-commandAction|54|123-postAction
                // write post-action user code here
             } else if (command == List.SELECT_COMMAND) {//GEN-LINE:|7-commandAction|55|117-preAction
                // write pre-action user code here
                 choosefriend1Action();//GEN-LINE:|7-commandAction|56|117-postAction
                // write post-action user code here
             } else if (command == backCommand4) {//GEN-LINE:|7-commandAction|57|122-preAction
                // write pre-action user code here
                 switchDisplayable(null, getRecommend());//GEN-LINE:|7-commandAction|58|122-postAction
                // write post-action user code here
             } else if (command == okCommand2) {//GEN-LINE:|7-commandAction|59|120-preAction
                // write pre-action user code here
                 switchDisplayable(null, getRecommend());//GEN-LINE:|7-commandAction|60|120-postAction
                // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|61|81-preAction
         } else if (displayable == connectAccount) {
             if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|61|81-preAction
                // write pre-action user code here
                 connectAccountAction();//GEN-LINE:|7-commandAction|62|81-postAction
                // write post-action user code here
             }//GEN-BEGIN:|7-commandAction|63|312-preAction
         } else if (displayable == disliked) {
             if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|63|312-preAction
                 // write pre-action user code here
                 dislikedAction();//GEN-LINE:|7-commandAction|64|312-postAction
                 // write post-action user code here
             } else if (command == backCommand) {//GEN-LINE:|7-commandAction|65|314-preAction
                 // write pre-action user code here
                 switchDisplayable(null, getReadMore());//GEN-LINE:|7-commandAction|66|314-postAction
                 // write post-action user code here
...
//GEN-LINE:|7-commandAction|76|161-postAction
             ...
             if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|77|128-preAction
                // write pre-action user code here
                 likedAction();//GEN-LINE:|7-commandAction|78|128-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|100|186-postAction
                 ...
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|102|200-postAction
                 // write post-action user code here
             } else if (command == blockstory) {//GEN-LINE:|7-commandAction|103|202-preAction
                 // write pre-action user code here
//GEN-LINE:|7-commandAction|104|202-postAction
                 // write post-action user code here
...
//GEN-LINE:|7-commandAction|132|33-postAction
 ...
 // write post-init user code here
    ...
    public void genReqURL() {//GEN-END:|338-if|0|338-preIf
        ...
        boolean valid = reqURL.startsWith("http");
        if (true) {//GEN-LINE:|338-if|1|339-preAction
            try {
                // write pre-action user code here
