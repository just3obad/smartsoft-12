...
public class HelloMIDlet extends MIDlet implements CommandListener {
    ...
    static String SERVER_IP = "192.168.43.75";
...
//GEN-LINE:|7-commandAction|2|40-postAction
              ...
              final      String url = "http://"+SERVER_IP+":3000/stories/" + currentStoryID + "/comments/new";
              final      String data = "{\"user_id\":\"" + userID + "\",\"story_id\":\"" + currentStoryID + "\",\"content\":\"" + comment + "\"}";
               thr = new Thread("conn"){
                   public  String s =  sendData(url, data);
               };
               thr.start();
            ...
            if (command == back) {//GEN-END:|7-commandAction|119|53-preAction
                ...
                if (this.pas.getString().length() != 0 || this.confPas.getString().length() != 0) {//Check if user entered anything in the field
                    ...
                    if (this.pas.getString().equals(this.confPas.getString())) {//check equality pass and its confirmation
                        ...
                        if (this.pas.getString().length() < 6) {// check length of the pass
...
//GEN-LINE:|7-commandAction|122|49-postAction
            ...
            if (command == backCommand9) {//GEN-END:|7-commandAction|123|186-preAction
                ...
                switchDisplayable(getCommingS(), getReadMore());//GEN-LINE:|7-commandAction|130|194-postAction
                // write post-action user code here
                ...
                switchDisplayable(getCommingS(), getReadMore());//GEN-LINE:|7-commandAction|132|319-postAction
                // write post-action user code here
                ...
                switchDisplayable(getCommingS(), getReadMore());//GEN-LINE:|7-commandAction|134|317-postAction
                // write post-action user code here
            } else if (command == okCommand7) {//GEN-LINE:|7-commandAction|135|188-preAction
                // write pre-action user code here
                switchDisplayable(null, getCommentsMany());//GEN-LINE:|7-commandAction|136|188-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|142|321-postAction
                ...
                switchDisplayable(getCommingS(), getReadMore());//GEN-LINE:|7-commandAction|144|192-postAction
                // write post-action user code here
                ...
                switchDisplayable(getCommingS(), getReadMore());//GEN-LINE:|7-commandAction|146|190-postAction
                // write post-action user code here
...
//GEN-LINE:|7-commandAction|158|33-postAction
    ...
    public Command getOptions() {
        if (options == null) {//GEN-END:|62-getter|0|62-preInit
            // write pre-init user code here
            options = new Command("Toggle Interests", Command.SCREEN, 0);//GEN-LINE:|62-getter|1|62-postInit
            // write post-init user code here
    ...
    public Command getOkCommand7() {
        if (okCommand7 == null) {//GEN-END:|187-getter|0|187-preInit
            // write pre-init user code here
            okCommand7 = new Command("  Comment", Command.OK, 0);//GEN-LINE:|187-getter|1|187-postInit
            // write post-init user code here
...
//GEN-LINE:|454-if|2|455-postAction
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: commingS ">//GEN-BEGIN:|474-getter|0|474-preInit
    /**
     * Returns an initiliazed instance of commingS component.
     * @return the initialized component instance
     */
    public Alert getCommingS() {
        if (commingS == null) {//GEN-END:|474-getter|0|474-preInit
            // write pre-init user code here
            commingS = new Alert("alert3", "Comming Soon!", null, null);//GEN-BEGIN:|474-getter|1|474-postInit
            commingS.setTimeout(Alert.FOREVER);//GEN-END:|474-getter|1|474-postInit
            // write post-init user code here
