...
public class Midlet extends MIDlet {
    ...
    public void createMainUI(){
        ...
        add.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if(input.getText().length()!=0){
                    ...
                    int x = Integer.parseInt(input.getText()) + Integer.parseInt(input2.getText());
        ...
        Button subtract = new Button("subtract them");
        ...
        Button multiply = new Button("multiply them");
        ...
        Button divide = new Button("divide them");
        divide.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if(input.getText().length()!=0){
                    ...
                    double x = Double.parseDouble(input.getText()) / Double.parseDouble(input2.getText());
